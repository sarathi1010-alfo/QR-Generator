...
def run_verification():
    urls_to_check = [
        ...
        "/qr-codes/wedding-rsvp-qr-codes",
        "/qr-codes/trade-show-lead-capture-qr-codes",
        "/qr-codes/charity-gala-donation-qr-codes",
    ...
    "/qr-codes/clinic-discharge-instructions",
        ...
        "/blog/qr-codes-for-smart-packaging-guide",
        "/qr-codes/smart-packaging-authenticity",
        "/qr-codes/product-tracing-qr-codes",
        "/qr-codes/interactive-product-labels",
        "/qr-codes/warranty-registration-packaging",
        "/qr-codes/eco-friendly-packaging-instructions",
