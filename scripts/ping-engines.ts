...
const NEW_URLS = [
  ...
  `${SITE_URL}/blog/qr-codes-for-event-management-complete-guide`,
  `${SITE_URL}/qr-codes/event-vip-wristbands`,
  `${SITE_URL}/qr-codes/event-food-vendor-menus`,
  `${SITE_URL}/qr-codes/event-parking-passes`,
  `${SITE_URL}/qr-codes/event-session-feedback`,
  `${SITE_URL}/qr-codes/event-sponsor-booth-check-in`,
  `${SITE_URL}/blog/qr-codes-for-music-industry-guide`,
  `${SITE_URL}/qr-codes/music-venue-digital-ticketing`,
  `${SITE_URL}/qr-codes/concert-merchandise-sales`,
  `${SITE_URL}/qr-codes/band-tour-schedules`,
  `${SITE_URL}/qr-codes/artist-spotify-links`,
  `${SITE_URL}/qr-codes/vip-backstage-passes`,
  `${SITE_URL}/blog/qr-codes-for-logistics-tracking`,
  `${SITE_URL}/qr-codes/warehouse-pallet-tracking`,
  `${SITE_URL}/qr-codes/last-mile-delivery-confirmation`,
  `${SITE_URL}/qr-codes/supply-chain-temperature-logs`,
  `${SITE_URL}/qr-codes/freight-forwarding-manifests`,
  `${SITE_URL}/qr-codes/forklift-safety-checklists`,
