...
const NEW_URLS = [
  ...
  `${SITE_URL}/blog/qr-codes-for-smart-packaging-guide`,
  `${SITE_URL}/qr-codes/smart-packaging-authenticity`,
  `${SITE_URL}/qr-codes/product-tracing-qr-codes`,
  `${SITE_URL}/qr-codes/interactive-product-labels`,
  `${SITE_URL}/qr-codes/warranty-registration-packaging`,
  `${SITE_URL}/qr-codes/eco-friendly-packaging-instructions`,
