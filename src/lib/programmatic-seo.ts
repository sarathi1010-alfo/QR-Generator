...
},
{
  ...
  {
    slug: "nonprofit-gala-auctions",
    title: "Nonprofit Gala Auctions",
    headline: "QR Codes for Nonprofit Gala Auctions",
    description: "Increase fundraising revenue with QR codes for seamless silent auctions and instant donations at charity galas.",
    category: "business",
    primaryUse: "url",
    features: [
      "Instant mobile bidding on silent auction items",
      "Seamless paddle raise donation links",
      "Digital event programs and seating charts",
      "Share stories and videos about the charity's impact"
    ],
    faqs: [
      { q: "How do QR codes improve silent auctions?", a: "They eliminate paper bid sheets, allowing guests to bid from their phones anywhere in the room, which drives up competition and final prices." },
      { q: "Are mobile donations secure?", a: "Yes, when linked to encrypted payment processors like Stripe, donors can safely contribute using Apple Pay or Google Pay." },
      { q: "Where should the codes be placed?", a: "Place them next to auction items, in the printed program, and on large screens during the live appeal." }
    ]
  },
  {
    slug: "food-bank-donations",
    title: "Food Bank Donations",
    headline: "QR Codes for Food Bank Donations",
    description: "Make it easy for the community to support your food bank with instant QR code donation links at grocery store checkouts and community drives.",
    category: "business",
    primaryUse: "url",
    features: [
      "Instantly collect financial contributions",
      "Link to current high-need item lists",
      "Provide tax receipt forms automatically",
      "Recruit volunteers for sorting and distribution"
    ],
    faqs: [
      { q: "Where is the best place to put food bank QR codes?", a: "Partner with local grocery stores to place them at the checkout lines or on community bulletin boards." },
      { q: "Can I use a QR code to list needed items?", a: "Yes! Link the code to a dynamic web page that lists exactly what items are currently most needed by the pantry." },
      { q: "Can we use them for recurring donations?", a: "Absolutely, link the code to a donation form that defaults to a monthly giving option." }
    ]
  },
  {
    slug: "animal-shelter-adoptions",
    title: "Animal Shelter Adoptions",
    headline: "QR Codes for Animal Shelter Adoptions",
    description: "Streamline the adoption process and increase donations for your animal shelter using strategically placed QR codes.",
    category: "business",
    primaryUse: "url",
    features: [
      "Link to pet bios and adoption applications",
      "Instant donation links for medical funds",
      "Promote foster program sign-ups",
      "Share video updates of available animals"
    ],
    faqs: [
      { q: "How can QR codes help animals get adopted faster?", a: "Place a QR code on an animal's kennel card. Visitors can scan it to instantly watch a video of the pet playing, helping them form an emotional connection." },
      { q: "Can we use them for adoption events?", a: "Yes, use them on flyers or staff badges at off-site events to capture digital adoption applications instantly." },
      { q: "Do QR codes help with fundraising?", a: "Yes, you can create specific codes for emergency medical funds and share them on social media or direct mailers." }
    ]
  },
  {
    slug: "disaster-relief-funds",
    title: "Disaster Relief Funds",
    headline: "QR Codes for Disaster Relief Funds",
    description: "Mobilize emergency funding instantly. Use QR codes on news broadcasts, social media, and flyers to rapidly collect disaster relief donations.",
    category: "business",
    primaryUse: "url",
    features: [
      "Capture immediate donations during crisis news cycles",
      "Provide real-time updates on relief efforts",
      "Coordinate emergency volunteer deployment",
      "Distribute safety and evacuation information"
    ],
    faqs: [
      { q: "Why are QR codes good for disaster relief?", a: "During a crisis, speed is everything. A QR code shown on a TV broadcast allows viewers to donate instantly without searching for the correct relief organization online." },
      { q: "Can QR codes be shown on television?", a: "Yes, as long as they are displayed large enough and on screen for at least 15 seconds so viewers have time to scan." },
      { q: "Are they safe against fraud?", a: "Always ensure the QR code is generated by the official organization and links directly to a verified, secure donation portal." }
    ]
  },
  {
    slug: "volunteer-sign-up-forms",
    title: "Volunteer Sign-Up Forms",
    headline: "QR Codes for Volunteer Sign-Ups",
    description: "Grow your nonprofit's volunteer base by making onboarding frictionless with QR codes linked directly to digital sign-up forms.",
    category: "business",
    primaryUse: "url",
    features: [
      "Eliminate messy paper sign-up sheets",
      "Automatically sync volunteer data to your CRM",
      "Link to required training videos and waivers",
      "Capture sign-ups at community events instantly"
    ],
    faqs: [
      { q: "How do digital sign-up sheets compare to paper?", a: "Digital forms eliminate transcription errors, save staff time, and ensure volunteer data is immediately secure and actionable." },
